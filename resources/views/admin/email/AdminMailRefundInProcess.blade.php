...
<head>
    ...
    <title>Refund Processing Update for Order {{ $order->order_id }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear Admin,</p>
            <p>This is to inform you that the refund for Order {{ $order->order_id }} has been initiated successfully. However, the refund is still in processing and may take 3-5 business days to reflect in the customer's account.</p>
            ...
            <div class="inventory-info">
                <p>We will notify you once the refund is successfully completed.</p>
