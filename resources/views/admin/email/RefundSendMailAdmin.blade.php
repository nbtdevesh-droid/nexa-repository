...
<head>
    ...
    <title> Refund Processed Successfully {{ $order->order_id }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We are writing to inform you that a refund has been successfully processed for the following transaction:</p>
            ...
            <div class="inventory-info">
                <p>The payment provider has confirmed the completion of the refund, and the customer has been notified accordingly.</p>
