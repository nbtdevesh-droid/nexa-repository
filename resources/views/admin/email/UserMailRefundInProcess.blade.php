...
<head>
    ...
    <title>Your Refund is Being Processed for Order {{ $order->order_id }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hello,</p>
            <p>We wanted to inform you that your refund request for Order {{ $order->order_id }} has been processed by our team. The refund is currently being processed by your payment provider and may take 3-5 business days to reflect in your account.</p>
