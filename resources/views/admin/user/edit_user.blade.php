...
@section('content')
        ...
        <div class="row mb-2">
                <div class="col-12">
                    ...
                    <ol class="breadcrumb ">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('user.index') }}"> Wholesaler </a></li>
                        <li class="breadcrumb-item active"> Edit Wholesaler </li>
                    </ol>
                </div>            
            </div> 
        </div>
    ...
    <section class="content">
        ...
        <div class="add_new_form">
            <form enctype="multipart/form-data" id="edit_user" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="add_staff_input">
                            ...
                            <div class="add_staff_label_input form-group">
                        ...
                        <div class="add_staff_input">
                            ...
                            <div class="add_staff_label_input form-group">
                                <input type="tel" name="phone" class="form-control phoneInput"
                                    placeholder="Enter Phone Number" id="phone" value="{{ $user->country_code . $user->phone }}">
                    ...
                    <div class="col-md-6">
                        <div class="add_staff_input">
                            ...
                            <div class="add_staff_label_input">
                                ...
                                @if($user->image)
                                    <img src="{{ asset('admin-assets/assets/img/profile_img/user') }}/{{ $user->image }}"
            ...
            $("#edit_user").validate({
                rules: {
                    ...
                    email: {
                        ...
                        email: true,
                        remote: {
                            url: base_url + 'unique-email-user',
                            type: 'POST',
                            data: {
                                email: function () {
                                ...
                                user_id: function () {
                                    return $('input[name="user_id"]').val(); // Get staff ID
                                },
                    ...
                    phone: {
                        required: true,
                        remote: {
                            url: base_url + 'unique-phone-number-user',
                            type: 'POST',
                            data: {
                                phone: function () {
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ route('user.update', $user->id) }}", // Your server-side form handling route
                        method: 'POST',
