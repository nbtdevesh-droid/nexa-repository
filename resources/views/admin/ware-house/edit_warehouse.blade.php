    ...
    <section class="content">
        <div class="container-fluid">
            <div class="add_new_form">
                ...
                <form method="POST" id="edit_warehouse" action="">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="add_staff_label_input">
                                ...
                                <div class="add_staff_input form-group">
                                    <input type="text" name="warehouse_name" id="warehouse_name" value="{{ $warehouse->warehouse_name }}"
                        ...
                        <div class="col-md-6">
                            <div class="add_staff_label_input">
                                ...
                                <div class="add_staff_input form-group">
                                    <input type="text" name="contact_name" id="contact_name" value="{{ $warehouse->contact_name }}"
                        ...
                        <div class="col-md-6">
                            <div class="add_staff_label_input">
                                ...
                                <div class="add_staff_input form-group">
                                    <input type="email" name="contact_email" id="contact_email" value="{{ $warehouse->contact_email }}"
                        ...
                        <div class="col-md-6">
                            <div class="add_staff_label_input">
                                ...
                                <div class="add_staff_input form-group">
                                    <input type="tel" name="contact_number" class="form-control contact_number phoneInput" 
                                        placeholder="Enter Contact Number" id="phone" value="{{ $warehouse->country_code . $warehouse->contact_number }}">
                        ...
                        <div class="col-md-12">
                            <div class="add_staff_label_input">
                                ...
                                <div class="add_staff_input form-group">
                                <textarea class="form-control street_address" name="street_address" style="background-color: #494A54; border-radius: 10px; height: 156px; color: #ffffff;">{{ $warehouse->street_address }}</textarea>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <select name="country" id="country" class="form-control">
                                        ...
                                        @if($countries->isNotEmpty())
                                            @foreach($countries as $country)
                                                <option value="{{ $country->id }}" {{ $warehouse->country == $country->name ? 'selected' : '' }}>{{ $country->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                    ...
                                    <select name="state" id="state" class="form-control" required>
                                        ...
                                        @if($states->isNotEmpty())
                                            @foreach($states as $state)
                                                <option value="{{ $state->id }}" {{ $warehouse->state == $state->name ? 'selected' : '' }}>{{ $state->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                    ...
                                    <select name="city" id="city" class="form-control" required>
                                        ...
                                        @if($cities->isNotEmpty())
                                            @foreach($cities as $city)
                                                <option value="{{ $city->name }}" {{ $warehouse->city == $city->name ? 'selected' : '' }}>{{ $city->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="add_staff_label_input">
                                ...
                                <div class="add_staff_input form-group">
                                    <input type="number" name="postal_code" id="postal_code" value="{{ $warehouse->zip_code }}"
        ...
        $(document).ready(function () {
            ...
            $("#edit_warehouse").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ route('warehouse.update', $warehouse->id) }}", // Your server-side form handling route
                        method: 'POST',
