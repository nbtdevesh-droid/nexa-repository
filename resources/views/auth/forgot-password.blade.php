                ...
                <div class="second_section">
                    <div class="card-body">
                        ...
                        <div class="login_heading">
                            ...
                            <p>If you've forgotten your password, don't worry! Enter your email address and we'll send you instructions to reset your password.</p>
                        </div>
                        <form action="{{ route('recover-password') }}" method="post">
                            ...
                            <div class="login_btn_forgot_password ">
                                <button type="submit" class="requst_btn">Request new password</button>
                            </div>
                        </form>
